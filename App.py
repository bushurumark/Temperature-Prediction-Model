...
is_sun = st.selectbox("Availability of Sun(0: 'Not Sunny', 1: 'Sunny')", [0, 1])
...
weather_type = st.selectbox("Weather Type(1: 'Clear', 2: 'Clouds', 3: 'Rain', 4: 'Snow', 5: 'Other')", [1, 2, 3, 4, 5])
